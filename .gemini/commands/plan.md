description = "Prepare a plan that implements a PRD or subcomponent, informed by recent research."
prompt = """
We are going to work on {{args}}.

Think hardest. Make a detailed plan to accomplish this, based on given research.
...
- Reinforce GEMINI.md rules when relevant, especially around code clarity, simplicity, reuse, and third-party usage
